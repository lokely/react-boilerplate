...
var history_createBrowserHistory = __webpack_require__(38);
...
var history_createMemoryHistory = __webpack_require__(40);
...
var value_equal = __webpack_require__(15);
...
var PathUtils = __webpack_require__(5);
...
var hoist_non_react_statics = __webpack_require__(43);
...
_reactDom2.default.render(_react2.default.createElement(_app2.default, { router: _reactRouterDom.BrowserRouter }),
/*global document*/
...
/*
 ...
 LICENSE file in the root directory of this source tree.
*/
var f=__webpack_require__(12),p=__webpack_require__(13);__webpack_require__(8);var r=__webpack_require__(6);
...
*/
var aa=__webpack_require__(0);__webpack_require__(8);var l=__webpack_require__(28),n=__webpack_require__(12),ba=__webpack_require__(29),ca=__webpack_require__(6),da=__webpack_require__(13),ea=__webpack_require__(30),fa=__webpack_require__(31),ha=__webpack_require__(34),ia=__webpack_require__(35);
...
var _RouteWrapper = __webpack_require__(47);
  ...
  _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        null,
        _pages2.default.map(route => _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _extends({ preload: route.preload }, route, props),
            _react2.default.createElement(route.component, props)
          )
        ))
      )
    )
...
const About = () => _react2.default.createElement(
  ...
  _react2.default.createElement(
    "p",
    null,
    "This react boilerplate was brought to you by ",
    _react2.default.createElement(
      "a",
      { href: "https://lokely.co", target: "_blank", rel: "noopener noreferrer" },
      "Lokely"
    )
  )
);
...
class RouteWrapper extends _react.Component {
  ...
  fetchData() {
    ...
    return _asyncToGenerator(function* () {
      if (typeof document !== 'undefined' && _this.props.title) {
        /*global document*/
        document.title = _this.props.title;
      }
      if (_this.props.preload) {
        try {
          const data = _this.props.preload(_this.props.match, {
            cancelToken: new _axios.CancelToken(function (c) {
              _this.cancelPreload = c;
            })
          });
          _this.setState({ data });
        } catch (error) {
  ...
  render() {
    ...
    return _react2.default.createElement(
      'div',
      { className: 'Route' },
      childState.error && _react2.default.createElement(
        'div',
        { className: 'Error' },
        'Error: ',
        childState.error
      ),
      _react2.default.cloneElement(children, childState)
    );
  }
}
...
exports.default = (0, _reactRouterDom.withRouter)(RouteWrapper);
...
const Navigation = () => _react2.default.createElement(
  ...
  _pages2.default.map(page => _react2.default.createElement(
    'li',
    { key: page.path },
    _react2.default.createElement(
